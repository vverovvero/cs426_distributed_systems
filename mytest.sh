...
curl -H "Content-Type: application/json" -X POST -d '{"node_id":0}' http://104.154.145.208:7080/api/v1/add_node
curl -H "Content-Type: application/json" -X POST -d '{"node_id":3}' http://104.154.145.208:7080/api/v1/add_node
curl -H "Content-Type: application/json" -X POST -d '{"node_id":6}' http://104.154.145.208:7080/api/v1/add_node
...
curl -H "Content-Type: application/json" -X POST -d '{"node_id":0}' http://104.154.145.208:7080/api/v1/get_node
curl -H "Content-Type: application/json" -X POST -d '{"node_id":3}' http://104.154.145.208:7080/api/v1/get_node
curl -H "Content-Type: application/json" -X POST -d '{"node_id":6}' http://104.154.145.208:7080/api/v1/get_node
...
curl -H "Content-Type: application/json" -X POST -d '{"node_a_id":0, "node_b_id":1}' http://104.154.145.208:7080/api/v1/add_edge
curl -H "Content-Type: application/json" -X POST -d '{"node_a_id":2, "node_b_id":3}' http://104.154.145.208:7080/api/v1/add_edge
curl -H "Content-Type: application/json" -X POST -d '{"node_a_id":3, "node_b_id":4}' http://104.154.145.208:7080/api/v1/add_edge
curl -H "Content-Type: application/json" -X POST -d '{"node_a_id":5, "node_b_id":6}' http://104.154.145.208:7080/api/v1/add_edge
curl -H "Content-Type: application/json" -X POST -d '{"node_a_id":6, "node_b_id":7}' http://104.154.145.208:7080/api/v1/add_edge
...
curl -H "Content-Type: application/json" -X POST -d '{"node_a_id":0, "node_b_id":1}' http://104.154.145.208:7080/api/v1/get_edge
curl -H "Content-Type: application/json" -X POST -d '{"node_a_id":2, "node_b_id":3}' http://104.154.145.208:7080/api/v1/get_edge
curl -H "Content-Type: application/json" -X POST -d '{"node_a_id":3, "node_b_id":4}' http://104.154.145.208:7080/api/v1/get_edge
curl -H "Content-Type: application/json" -X POST -d '{"node_a_id":5, "node_b_id":6}' http://104.154.145.208:7080/api/v1/get_edge
curl -H "Content-Type: application/json" -X POST -d '{"node_a_id":6, "node_b_id":7}' http://104.154.145.208:7080/api/v1/get_edge
...
curl -H "Content-Type: application/json" -X POST -d '{"node_id":0}' http://104.154.145.208:7080/api/v1/get_neighbors
curl -H "Content-Type: application/json" -X POST -d '{"node_id":3}' http://104.154.145.208:7080/api/v1/get_neighbors
curl -H "Content-Type: application/json" -X POST -d '{"node_id":6}' http://104.154.145.208:7080/api/v1/get_neighbors
...
curl -H "Content-Type: application/json" -X POST -d '{"node_a_id":0, "node_b_id":1}' http://104.154.145.208:7080/api/v1/remove_edge
curl -H "Content-Type: application/json" -X POST -d '{"node_a_id":2, "node_b_id":3}' http://104.154.145.208:7080/api/v1/remove_edge
curl -H "Content-Type: application/json" -X POST -d '{"node_a_id":3, "node_b_id":4}' http://104.154.145.208:7080/api/v1/remove_edge
curl -H "Content-Type: application/json" -X POST -d '{"node_a_id":5, "node_b_id":6}' http://104.154.145.208:7080/api/v1/remove_edge
curl -H "Content-Type: application/json" -X POST -d '{"node_a_id":6, "node_b_id":7}' http://104.154.145.208:7080/api/v1/remove_edge
