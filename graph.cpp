...
//////////////////////////////////////////////////////////////////////////////////////////
/* Graph functions for use with Checkpoint 												*/
//////////////////////////////////////////////////////////////////////////////////////////

uint64_t Graph::get_num_nodes(){
	uint64_t num_nodes = this->nodes.size();
	return num_nodes;
}

//returns an iterator through all nodes in the hash_map
//uint64_t node = (*node_iterator).first;
// map<uint64_t, set<uint64_t> >::iterator Graph::get_node_iterator(){
// 	map<uint64_t, set<uint64_t> >::iterator node_iterator = this->nodes.begin();
